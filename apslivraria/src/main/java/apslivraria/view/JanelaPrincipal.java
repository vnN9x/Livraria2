...
public class JanelaPrincipal extends JFrame implements View{
	...
	private JPanel createBuscaJPanel(Model model) {
		...
		// panel para os check boxes de sele��o de busca
	...
	private JPanel createAlteraJPanel(Model m4) {
		...
		//vars
		altera_jbutton_run = new JButton("Executar Altera��o");
		...
		altera_jtextfield_livro_preco = new JTextField("Novo pre�o", 10);
		...
		altera_jcombobox_opcoes_autor.addActionListener(new inclui_action_listener(altera_map_jcombobox_boolean_todas_opcoes_jcomboboxes_autor, altera_jpanel_livro_horizontal_alignment_group, model.findAllAuthors(), busca_jtextfield_input));
		...
		// TODO:escrever action listener da execu��o
	...
	private JPanel createIncluiJPanel(Model m4) {
		...
		inclui_jtextfield_livro_preco = new JTextField("Pre�o", 10);
		...
		// Incluindo o primeiro combobox no Map de comboboxes de sele��o dos autores
		...
		// Jpanel do card layout, que ira possibilitar a alternancia entre os 3 panels de edi��o(livro, editora, autor)
		...
		// Action listener para o bot�o principal de execu��o do painel de inclus�o
...
//						String crnt_author_name = (String)crnt_combobox.getSelectedItem();
						// PROBLEMA É COM O CAST DO COMBOBOX NULO
